...
export default function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div className="flex">
              <div className="flex-shrink-0 flex items-center">
                ...
                >
                  ...
                  <span className="text-base sm:text-lg font-semibold tracking-wide text-gray-900 dark:text-white">
                    {sectionTitle}
                  </span>
                </button>
              </div>
                  ...
                  <Link
                    ...
                    className={`${
                      location.pathname === item.path
                        ? 'border-[#d27b30] text-gray-900 dark:text-white'
      ...
      >
        <div
          className="flex items-end justify-center text-xs text-gray-500 dark:text-gray-400 transition-[height] duration-150"
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 z-40 border-t border-gray-200 dark:border-gray-700 bg-white/95 dark:bg-gray-800/95 backdrop-blur">
